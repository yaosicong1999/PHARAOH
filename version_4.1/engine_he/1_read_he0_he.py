# ============================================================
# 1_read_he0_he.py - Stage 1: Image selection & orientation
#
# Loads two H&E images (reference HE + moving HE0), previews the
# hematoxylin masks/thresholds, lets the user fix HE0 orientation,
# and saves images_info.json plus the confirmed dense masks.
# Usage: python 1_read_he0_he.py <RUN_DIR>
# ============================================================
...
def select_he0():
    ...
    log_event("user_click_he0_import")
    path = filedialog.askopenfilename(title="Select H&E0 Image")
    he0_path = path
    if not path:
        log_event("user_cancel_he0_selection")
        return
    ...
    log_event(
        "system_ready_he0_import",
        he0_path=str(path),
        he0_shape=list(he0_orig.shape),
        he0_level=he0_level,
    )
...
def confirm_and_save():
    ...
    log_event(
        ...
        he0_path=str(he0_img_path),
        he_mask_path=str(he_dense_path),
        he0_mask_path=str(he0_dense_path),
    )
...
def main():
    ...
    root.title("Stage 1: H&E0 & H&E Viewer")
