...
#
# Crops DAPI/H&E patches around each standout nucleus and writes
# nuclei_patches/nuclei_centroids_global.json (gates Stages 5-6).
...
def process_dapi(
    ...
    try:
        ...
        if isinstance(cc_info, dict):
            kept = cc_info.get("cc_kept", None)
            total = cc_info.get("cc_total", None)
