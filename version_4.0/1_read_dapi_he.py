# ============================================================
# 1_read_dapi_he.py - Stage 1: Image selection & orientation
#
# Loads H&E and DAPI images, previews masks/thresholds, lets the
# user fix DAPI orientation, and saves images_info.json plus the
# confirmed dense masks / LUT preview into <RUN_DIR>.
# Usage: python 1_read_dapi_he.py <RUN_DIR>
# ============================================================
import json
import os
import sys
