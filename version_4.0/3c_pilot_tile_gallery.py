# ============================================================
# 3c_pilot_tile_gallery.py - Stage 3 (pilot): Pilot tile gallery
#
# Tk gallery to preview pilot DAPI/H&E tiles and tune DAPI/H&E
# mask thresholds, saving the chosen values to
# pilot_output_parameters.json.
# Usage: python 3c_pilot_tile_gallery.py <RUN_DIR> [PILOT_DIR]
# ============================================================
...
def show_pilot_gallery(
    ...
    # -------------------------
    dapi_thr_var = tk.StringVar(value="0")  # THR_OFFSET (relative to Otsu), default 0
    he_thr_var = tk.StringVar(value="0.60")  # intensity_threshold, default 0.60
