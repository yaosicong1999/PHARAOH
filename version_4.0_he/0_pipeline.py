# ============================================================
# 0_pipeline.py - Pipeline launcher (Stages 1-6)
#
# Qt GUI to select/create a RUN_DIR and run each pipeline stage
# as a subprocess, tracking per-stage completion status and
# timing in <RUN_DIR>/pipeline_times.json.
# Usage: python 0_pipeline.py
# ============================================================
import os
import sys
